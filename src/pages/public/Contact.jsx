          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">+237 675 72 06 03</p>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">contact@agrojeuneentrepreneur.cm</p>
                <p className="text-sm text-secondary">support@agrojeuneentrepreneur.cm</p>
              </div>
            </div>
